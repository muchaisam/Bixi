...
// Custom dialog class with a blurred background
...
//        window.statusBarColor = ContextCompat.getColor(context, R.color.colorPrimaryVariant)
//    }
}